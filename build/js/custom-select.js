...
for (i = 0; i < l; i++) {
  ...
  a.addEventListener("click", function(e) {
    ...
    document.querySelector('.triangle').classList.toggle('select-hide')
...
let specifiedElement = document.querySelector('.input-select');
...
document.addEventListener('click', function(event) {
  ...
  if (!isClickInside) {
    ...
    document.querySelector('.triangle').classList.add('select-hide')
